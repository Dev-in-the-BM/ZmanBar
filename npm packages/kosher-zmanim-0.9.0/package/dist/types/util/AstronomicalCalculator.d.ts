...
export declare abstract class AstronomicalCalculator {
     ...
     */
    abstract getUTCNoon(date: DateTime, geoLocation: GeoLocation): number;
    /**
     ...
     * @return the time in minutes from zero UTC
     */
    abstract getUTCMidnight(date: DateTime, geoLocation: GeoLocation): number;
    /**

...
class ComplexZmanimCalendar extends ZmanimCalendar_1.ZmanimCalendar {
  ...
  */
    ...
    getMinchaGedolaAhavatShalom() {
        if (this.getChatzos() === null || this.getMinchaGedola30Minutes() === null
            || this.getShaahZmanisAlos16Point1ToTzais3Point7() === Utils_1.Long_MIN_VALUE) {
            return null;
        }
    ...
    getZmanisBasedOffset(hours) {
        ...
        if (shaahZmanis === Utils_1.Long_MIN_VALUE || hours === 0) {
            return null;
        }
        return hours > 0
  ...
  */
    ...
    getSofZmanAchilasChametzMGA72MinutesZmanis() {
        const jewishCalendar = new JewishCalendar_1.JewishCalendar();
        jewishCalendar.setGregorianDate(this.getDate().year, this.getDate().month - 1, this.getDate().day);
        if (jewishCalendar.getJewishMonth() === JewishCalendar_1.JewishCalendar.NISSAN && jewishCalendar.getJewishDayOfMonth() === 14) {
    ...
    getMinchaGedolaGRAFixedLocalChatzos30Minutes() {
        return ZmanimCalendar_1.ZmanimCalendar.getTimeOffset(this.getFixedLocalChatzos(), ZmanimCalendar_1.ZmanimCalendar.MINUTE_MILLIS * 30);
    }
    /**
     ...
     */
    getTzais50() {
        return ZmanimCalendar_1.ZmanimCalendar.getTimeOffset(this.getElevationAdjustedSunset(), 50 * ZmanimCalendar_1.ZmanimCalendar.MINUTE_MILLIS);
    }
    /**

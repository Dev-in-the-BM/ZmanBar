...
class ZmanimCalendar extends AstronomicalCalendar_1.AstronomicalCalendar {
    constructor() {
         ...
         */
        this.useAstronomicalChatzos = true;
        /**
         ...
         * @see #getChatzos()
         */
        this.useAstronomicalChatzosForOtherZmanim = false;
        /**
     ...
     * @see #setUseAstronomicalChatzosForOtherZmanim(boolean)
     */
    setUseAstronomicalChatzos(useAstronomicalChatzos) {
     ...
     * @see #isUseAstronomicalChatzos()
     */
    setUseAstronomicalChatzosForOtherZmanim(useAstronomicalChatzosForOtherZmanim) {
     ...
     */
    getSofZmanShma(startOfDay, endOfDay, synchronous) {
    ...
    */
     ...
     */
    getSofZmanTfila(startOfDay, endOfDay, synchronous) {
        if (this.isUseAstronomicalChatzosForOtherZmanim() && synchronous) {
    ...
    */
    ...
    getMinchaGedola(startOfDay, endOfDay, synchronous) {
    ...
    */
     ...
     */
    getSamuchLeMinchaKetana(startOfDay, endOfDay, synchronous) {
        if (this.isUseAstronomicalChatzosForOtherZmanim() && synchronous) {
    ...
    */
     ...
     *         be returned. See detailed explanation on top of the {@link AstronomicalCalendar} documentation.
     */
    getMinchaKetana(startOfDay, endOfDay, synchronous) {
        if (startOfDay === undefined && endOfDay === undefined) {
            // eslint-disable-next-line no-param-reassign
            startOfDay = this.getElevationAdjustedSunrise();
            // eslint-disable-next-line no-param-reassign
    ...
    */
     ...
     */
    getPlagHamincha(startOfDay, endOfDay, synchronous) {
        if (startOfDay === undefined && endOfDay === undefined) {
            // eslint-disable-next-line no-param-reassign
            startOfDay = this.getElevationAdjustedSunrise();
            // eslint-disable-next-line no-param-reassign
    ...
    */
    ...
    getPercentOfShaahZmanisFromDegrees(degrees, sunset) {
        ...
        if (seaLevelSunrise === null || seaLevelSunset === null || twilight === null) {
            return Utils_1.Double_MIN_VALUE;
        }
        const shaahZmanis = (seaLevelSunset.valueOf() - seaLevelSunrise.valueOf()) / 12.0;
    ...
    getHalfDayBasedZman(startOfHalfDay, endOfHalfDay, hours) {
        if (startOfHalfDay === null || endOfHalfDay === null)
            return null;
        const shaahZmanis = this.getHalfDayBasedShaahZmanis(startOfHalfDay, endOfHalfDay);
        if (shaahZmanis === Utils_1.Long_MIN_VALUE)
            return null; // defensive, should not be needed
        // forward from start a day
        if (hours >= 0)
            return ZmanimCalendar.getTimeOffset(startOfHalfDay, shaahZmanis * hours);
     ...
     */
    getHalfDayBasedShaahZmanis(startOfHalfDay, endOfHalfDay) {
        if (startOfHalfDay === null || endOfHalfDay === null)

...
var getRawOffset = Utils_1.TimeZone.getRawOffset;
/**
...
class AstronomicalCalendar {
    ...
    */
     ...
     */
    getDateFromTime(time, solarEvent) {
    ...
    getLocalMeanTime(hours) {
        if (hours < 0 || hours >= 24) {
            throw new errors_1.IllegalArgumentException('Hours must between 0 and 23.9999...');
        }

...
class HebrewDateFormatter {
    constructor() {
        ...
        this.transliteratedParshaMap = {
            ...
            [JewishCalendar_1.Parsha.SHUVA]: 'Shuva',
            [JewishCalendar_1.Parsha.SHIRA]: 'Shira',
            [JewishCalendar_1.Parsha.HAGADOL]: 'Hagadol',
            [JewishCalendar_1.Parsha.CHAZON]: 'Chazon',
            [JewishCalendar_1.Parsha.NACHAMU]: 'Nachamu',
        };
        /**
        ...
        this.hebrewParshaMap = {
            ...
            [JewishCalendar_1.Parsha.NITZAVIM]: '\u05E0\u05E6\u05D1\u05D9\u05DD',
            ...
            [JewishCalendar_1.Parsha.NITZAVIM_VAYEILECH]: '\u05E0\u05E6\u05D1\u05D9\u05DD \u05D5\u05D9\u05DC\u05DA',
            ...
            [JewishCalendar_1.Parsha.SHUVA]: '\u05E9\u05D5\u05D1\u05D4',
            [JewishCalendar_1.Parsha.SHIRA]: '\u05E9\u05D9\u05E8\u05D4',
            [JewishCalendar_1.Parsha.HAGADOL]: '\u05D4\u05D2\u05D3\u05D5\u05DC',
            [JewishCalendar_1.Parsha.CHAZON]: '\u05D7\u05D6\u05D5\u05DF',
            [JewishCalendar_1.Parsha.NACHAMU]: '\u05E0\u05D7\u05DE\u05D5',
        };
        /**
    ...
    formatDafYomiYerushalmi(daf) {
        if (daf === null) {
            return this.hebrewFormat ? Daf_1.Daf.getYerushalmiMasechtos()[39] : Daf_1.Daf.getYerushalmiMasechtosTransliterated()[39];
        }
        return this.hebrewFormat
    ...
    formatParsha(jewishCalendarOrParsha) {
        if (jewishCalendarOrParsha instanceof JewishCalendar_1.JewishCalendar) {
            const parsha = jewishCalendarOrParsha.getParsha();

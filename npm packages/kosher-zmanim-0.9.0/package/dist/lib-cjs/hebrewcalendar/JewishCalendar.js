...
(function (Parsha) {
    ...
    /** <em>Shabbos</em> Shuva */
    Parsha[Parsha["SHUVA"] = 66] = "SHUVA";
    /** <em>Shabbos</em> Shira */
    Parsha[Parsha["SHIRA"] = 67] = "SHIRA";
    /** <em>Shabbos</em> Hagadol */
    Parsha[Parsha["HAGADOL"] = 68] = "HAGADOL";
    /** <em>Shabbos</em> Chazon */
    Parsha[Parsha["CHAZON"] = 69] = "CHAZON";
    /** <em>Shabbos</em> Nachamu */
    Parsha[Parsha["NACHAMU"] = 70] = "NACHAMU";
...
class JewishCalendar extends JewishDate_1.JewishDate {
    ...
    getUpcomingParsha() {
        ...
        const daysToShabbos = (Utils_1.Calendar.SATURDAY - this.getDayOfWeek() + 7) % 7;
        if (this.getDayOfWeek() !== Utils_1.Calendar.SATURDAY) {
            clone.forward(Utils_1.Calendar.DATE, daysToShabbos);
        }
        else {
            clone.forward(Utils_1.Calendar.DATE, 7);
        }
        ...
        switch (this.getJewishMonth()) {
            case JewishCalendar.NISSAN:
                ...
                if (this.isUseModernHolidays()
                    && ((day === 26 && dayOfWeek === Utils_1.Calendar.THURSDAY) || (day === 28 && dayOfWeek === Utils_1.Calendar.MONDAY)
                        || (day === 27 && dayOfWeek !== Utils_1.Calendar.SUNDAY && dayOfWeek !== Utils_1.Calendar.FRIDAY))) {
                    return JewishCalendar.YOM_HASHOAH;
                }
                break;
            case JewishCalendar.IYAR:
                if (this.isUseModernHolidays()
                    && ((day === 4 && dayOfWeek === Utils_1.Calendar.TUESDAY) || ((day === 3 || day === 2) && dayOfWeek === Utils_1.Calendar.WEDNESDAY)
                        || (day === 5 && dayOfWeek === Utils_1.Calendar.MONDAY))) {
                ...
                if (this.isUseModernHolidays() && ((day === 5 && dayOfWeek === Utils_1.Calendar.WEDNESDAY)
                    || ((day === 4 || day === 3) && dayOfWeek === Utils_1.Calendar.THURSDAY) || (day === 6 && dayOfWeek === Utils_1.Calendar.TUESDAY))) {
            ...
            case JewishCalendar.TAMMUZ:
                ...
                if ((day === 17 && dayOfWeek !== Utils_1.Calendar.SATURDAY) || (day === 18 && dayOfWeek === Utils_1.Calendar.SUNDAY)) {
                    return JewishCalendar.SEVENTEEN_OF_TAMMUZ;
                }
                break;
            case JewishCalendar.AV:
                // if Tisha B'av falls on Shabbos, push off until Sunday
                if ((dayOfWeek === Utils_1.Calendar.SUNDAY && day === 10) || (dayOfWeek !== Utils_1.Calendar.SATURDAY && day === 9)) {
            ...
            case JewishCalendar.TISHREI:
                ...
                else if ((day === 3 && dayOfWeek !== Utils_1.Calendar.SATURDAY) || (day === 4 && dayOfWeek === Utils_1.Calendar.SUNDAY)) {
            ...
            case JewishCalendar.ADAR:
                if (!this.isJewishLeapYear()) {
                    ...
                    if (((day === 11 || day === 12) && dayOfWeek === Utils_1.Calendar.THURSDAY)
                        || (day === 13 && !(dayOfWeek === Utils_1.Calendar.FRIDAY || dayOfWeek === Utils_1.Calendar.SATURDAY))) {
    ...
    isYomKippurKatan() {
        ...
        const day = this.getJewishDayOfMonth();
        if (month === JewishDate_1.JewishDate.ELUL || month === JewishDate_1.JewishDate.TISHREI || month === JewishDate_1.JewishDate.KISLEV || month === JewishDate_1.JewishDate.NISSAN) {
            return false;
        }
        if (day === 29 && dayOfWeek !== Utils_1.Calendar.FRIDAY && dayOfWeek !== Utils_1.Calendar.SATURDAY) {
            return true;
        }
        return (day === 27 || day === 28) && dayOfWeek === Utils_1.Calendar.THURSDAY;
    }
    /**
    ...
    isBeHaB() {
        ...
        const month = this.getJewishMonth();
        const day = this.getJewishDayOfMonth();
        if (month === JewishDate_1.JewishDate.CHESHVAN || month === JewishDate_1.JewishDate.IYAR) {
            if ((dayOfWeek === Utils_1.Calendar.MONDAY && day > 4 && day < 18)
                || (dayOfWeek === Utils_1.Calendar.THURSDAY && day > 7 && day < 14)) {
                return true;
            }
        }
        return false;
    ...
    isTaanisBechoros() {
        ...
        return this.getJewishMonth() === JewishCalendar.NISSAN && ((day === 14 && dayOfWeek !== Utils_1.Calendar.SATURDAY)
            || (day === 12 && dayOfWeek === Utils_1.Calendar.THURSDAY));
    }
    /**
 ...
 */
JewishCalendar.YOM_KIPPUR_KATAN = 36;
/**
